 ...
 <h2 class="header-title">Student Register</h2>
            <div class="formbold-main-wrapper">
                <div class="formbold-form-wrapper">
                    <form action="Student_Register" method="POST" enctype="multipart/form-data" onsubmit="return form_validation()">
                        <!-- User Name -->
                        ...
                        <div class="formbold-mb-3">
                            <div>
                                ...
                                <input type="text" id="Register_Number" name="Register_Number" placeholder="Enter Register Number" class="formbold-form-input" required>
                            </div>
                        </div>
...
<script>
    function form_validation() {
        ...
        var registerNumber = document.getElementById("Register_Number").value.trim();
        if (!registerNumber) {
            alert("Register Number is required.");
            return false;
        }
        if (!registerNumber.match(/^[0-9]+$/)) {
            alert("Register Number should contain only numbers.");
            return false;
        }
